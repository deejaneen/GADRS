                            ...
                            <div class="row date">
                                <div class="col-md-6 date">
                                    <div class="date-container">
                                        ...
                                        <input type="text" id="availabilityDate" class="btn btn-calendar-dorm"
                                            min="{{ date('Y-m-d') }}" placeholder="Select a date">
                                    </div>
                                </div>
                                <div class="col-md-6 availability">
                                    <h3 class="availability" id="bedAvailabilityMale">Availability: <b
                                            style="color: var(--color-orange)">{{ $beds_male }} beds</b></h3>
                                </div>
                            </div>
                            <!-- Check In, Check Out -->
                            <hr>
                            <div class="row">
                                <div class="col-md-6 time" style="text-align: center;">
                                    ...
                                    <div class="dropdown-center">
                                        ...
                                        <input type="text" id="reservation_start_date"
                                            class="btn btn-calendar-datetime" min="{{ date('Y-m-d') }}"
                                            placeholder="Select a date" name="reservation_start_date" required>
                                ...
                                <div class="col-md-6 time" style="text-align: center;">
                                    ...
                                    <div class="dropdown-center">
                                        ...
                                        <input type="text" id="reservation_end_date"
                                            class="btn btn-calendar-datetime" min="{{ date('Y-m-d') }}"
                                            placeholder="Select a date" name="reservation_end_date" required>
                            ...
                            <div class="row date">
                                <div class="col-md-6 date">
                                    <div class="date-container">
                                        ...
                                        <input type="text" id="availabilityDateFemale"
                                            class="btn btn-calendar-dorm" min="{{ date('Y-m-d') }}"
                                            placeholder="Select a date">
                                    </div>
                                </div>
                                <div class="col-md-6 availability">
                                    <h3 class="availability" id="bedAvailabilityFemale">Availability: <b
                                            style="color: var(--color-orange)">{{ $beds_female }} beds</b></h3>
                                    </h3>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6 time" style="text-align: center;">
                                    ...
                                    <div class="dropdown-center">
                                        ...
                                        <input type="text" id="reservation_start_date_female"
                                            class="btn female btn-calendar-datetime" min="{{ date('Y-m-d') }}"
                                            placeholder="Select a date" name="reservation_start_date" required>
                                        <input type="time" class="btn btn-calendar-datetime time" value="14:00"
                                            autocomplete="off" readonly name="reservation_start_time">
                                    </div>
                                ...
                                <div class="col-md-6 time" style="text-align: center;">
                                    ...
                                    <div class="dropdown-center">
                                        ...
                                        <input type="text" id="reservation_end_date_female"
                                            class="btn female btn-calendar-datetime" min="{{ date('Y-m-d') }}"
                                            placeholder="Select a date" name="reservation_end_date" required>
                                        <input type="time" class="btn btn-calendar-datetime time" value="12:00"
                                            autocomplete="off" readonly name="reservation_end_time">
