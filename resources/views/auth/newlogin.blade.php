...
<div class="container">
    <div class="login-container">
        ...
        <div class="login-section">
            ...
            <form action="{{ route('newlogin') }}" method="post"> <!-- Properly nested form tags -->
                @csrf
                ...
                <button type="submit" class="btn-login btn btn-primary">Login</button> <!-- Added type="submit" -->
            </form>
            <div class="bottom-link">
                <p>
                    Don't have an account? <a href="{{ route('register') }}" style="color: var(--color-orange)">Register</a>
                </p>
            </div>
        </div>
