            ...
            <tbody>
                ...
                <tr class="table-active">
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.editUser', $user->id) }}" class="btn btn-primary btn-edit-profile">
                        ...
                        <form class="delete-form-user" id="adminUserIdDelete_{{ $user->id }}" name="admin_user_id_delete" action="{{ route('admin.destroyUser', $user->id) }}" method="POST">
                            ...
                            <button class="btn btn-primary btn-lg rounded-pill" onclick="confirmDeleteDorm(event)" style="color: var(--color-danger);">
                                Delete
                            </button>
                        </form>
