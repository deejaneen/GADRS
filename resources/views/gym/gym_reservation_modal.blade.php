    ...
    <div class="modal-dialog modal-dialog-centered modal-xl d-flex align-items-center justify-content-center ">
        <form id="reservationForm" class="modal-content gym-modal">
                ...
                <div class="container">
                    <div class="row" style="justify-content: center;">
                        ...
                        <div class="btn-group" style="min-width: 100%;">
                            ...
                            <ul class="dropdown-menu btn-dropdown-modal " aria-labelledby="dropdownMenuButton" style="min-width: 100%;"
                                id="date-dropdown">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h5>Start Time</h5>
                            <div class="btn-group" style="min-width: 100%;">
                                <button class="btn btn-dropdown-modal  rounded-btn" type="button"
                                    id="startTimeDropdownButton" data-bs-toggle="dropdown" aria-expanded="false">
                                    Dropdown
                                </button>
                                <ul class="dropdown-menu btn-dropdown-modal " aria-labelledby="startTimeDropdownButton"
                                    style="min-width: 100%;">
                                    <li><a class="dropdown-item">Menu item</a></li>
                                    <li><a class="dropdown-item">Menu item</a></li>
                                    <li><a class="dropdown-item">Menu item</a></li>
                            ...
                            <p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    style="color: red;" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2"
                        ...
                        <div class="col-md-6">
                            ...
                            <h5>End Time</h5>
                            <div class="btn-group" style="min-width: 100%;">
                                <button class="btn btn-dropdown-modal rounded-btn" type="button" id="endTimeDropdownButton"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Dropdown
                                </button>
                                <ul class="dropdown-menu btn-dropdown-modal " aria-labelledby="endTimeDropdownButton"
                                    style="min-width: 100%;">
                                    <li><a class="dropdown-item">Menu item</a></li>
                                    <li><a class="dropdown-item">Menu item</a></li>
                                    <li><a class="dropdown-item">Menu item</a></li>
                            ...
                            <div class="btn-group" style="min-width: 100%;">
                                ...
                                <ul class="dropdown-menu btn-dropdown-modal " aria-labelledby="reservorDropdownButton"
                                    style="min-width: 100%;">
                                    <li><a class="dropdown-item">Menu item</a></li>
                                    <li><a class="dropdown-item">Menu item</a></li>
                                    <li><a class="dropdown-item">Menu item</a></li>
            ...
            <div class="modal-footer" style="justify-content: center;">
                ...
                <button type="button" class="btn btn-add-cart-gym rounded-btn btn-add-to-cart" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasRight">Add to Cart</button>
            </div>
        </form>
    </div>
</div>
