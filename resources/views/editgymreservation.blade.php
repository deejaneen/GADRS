        ...
        <form id="editReservationForm" action="{{ route('gym.update', $reservation->id) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="form-group col-6">
                    ...
                    <input type="time" class="form-control" id="reservation_time_start" name="reservation_time_start" value="{{ $reservation->reservation_time_start }}">
                </div>
                <div class="form-group col-6">
                    <label for="reservation_time_end">End Time</label>
                    <input type="time" class="form-control" id="reservation_time_end" name="reservation_time_end" value="{{ $reservation->reservation_time_end }}">
                </div>
            </div>
            <div class="row mb-3">
                <div class="form-group col-6">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Function to update visibility based on selected value
        function updateNumberOfCourtsVisibility() {
            if (purposeSelect.value === 'Badminton') {
        ...
        updateNumberOfCourtsVisibility();

        // Add event listener for changes
        purposeSelect.addEventListener('change', updateNumberOfCourtsVisibility);
    });
</script>
@endsection